...
bw <- brain_data[,c(1,3,5)] %>% gather(key = 'name1', value = 'BW', 1,2,3) %>% filter(BW != na)
brw <- brain_data[,c(2,4,6)] %>% gather(key = 'name2', value = 'BRW', 1,2,3) %>% filter(BRW != na)
...
ggarrange(hist_ife_base, hist_pusa_base, hist_ife_tidyverse, hist_pusa_tidyverse, ncol = 2, nrow = 2)
