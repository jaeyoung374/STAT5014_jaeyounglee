...
You should add some to what you are looking to do.

In this problem, I first looked at the internal R datasets, chose the trees dataset and then created a summary table and plots.
...
## there are more options to the summary function, add a caption/title, formatting, etc
knitr::kable(summary(trees))              # Summary of trees data
