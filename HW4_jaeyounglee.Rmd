...
knitr::kable(table(cities$V4), col.names = c('States', 'Cities'))
...
library(maps)
states %>% inner_join(cities, by = "V4")
substring('abcdefg', 2)

# US map data
mainstates <- map_data('state')

# Change the states names with capital letter
for(i in 1:nrow(states)){
  mainstates$region[substring(mainstates$region, 2) == substring(states$V2[i], 2)] = states$V2[i]
}
